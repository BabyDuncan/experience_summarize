...
> i find this in the sutiation below: I worked in ~/project and it works well , i deleted it and have a vocation
> when i came back ,i clone the project in /temp/project ,it works bad ,fuck it !!! so i found the framework dir points
> to ~/project the older dir , i change it to /temp/project , then it works well again ,fuck !!!! you had better change 
> it to ${project} or some else like that .I cannot remember .
